    ...
    <Box flexDirection="column" marginBottom={1}>
      {cols >= (t.bannerLogo ? artWidth(logoLines) : LOGO_WIDTH) ? (
        ...
        <Text bold color={t.color.primary}>
          {t.brand.icon} MERIDIAN
        </Text>
      )}

      <Text color={t.color.muted}>{t.brand.icon} Meridian Digital Agency · Intelligent brand operations</Text>
    </Box>
  )
}
      ...
      {wide && (
        <Box flexDirection="column" marginRight={2} width={leftW}>
          ...
          <Text color={t.color.accent}>
            ...
            <Text color={t.color.muted}> · Meridian</Text>
          </Text>
