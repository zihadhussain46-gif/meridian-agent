...
- [ ] Hermes ran the canonical tests itself, using `scripts/run_tests.sh` for Meridian Agent or the repo's documented wrapper for other repos.
...
```json
{
  "codex_lane": {
    ...
    "tests_run": [
      {"command": "scripts/run_tests.sh tests/tools/test_x.py", "exit_code": 0, "owner": "meridian"},
