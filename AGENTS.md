# Meridian Agent - Development Guide
...
4. **`author` credits the human contributor first.** For external
   ...
   first; "Meridian Agent" is the secondary collaborator. If the
   contributor's commit shows "Meridian Agent" as author (because they
