...
Pure display functions with no MeridianCLI state dependency.
"""
...
def format_banner_version_label() -> str:
    ...
    base = f"Meridian Agent v{VERSION} ({RELEASE_DATE})"
...
def build_welcome_banner(console: "Console", model: str, cwd: str,
    ...
    """Build and print a welcome banner with signal on left and info on right.
    ...
    try:
        ...
        _hero = _bskin.banner_hero if hasattr(_bskin, 'banner_hero') and _bskin.banner_hero else MERIDIAN_SIGNAL
    except Exception:
        _bskin = None
        _hero = MERIDIAN_SIGNAL
    left_lines = ["", _hero, ""]
    ...
    if term_width >= 95:
        _logo = _bskin.banner_logo if _bskin and hasattr(_bskin, 'banner_logo') and _bskin.banner_logo else MERIDIAN_AGENT_LOGO
        console.print(_logo)
        console.print()
