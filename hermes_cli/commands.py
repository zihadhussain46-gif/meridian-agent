...
COMMAND_REGISTRY: list[CommandDef] = [
    ...
    CommandDef("rollback", "List or restore filesystem checkpoints", "Session",
               args_hint="[number]"),
    CommandDef("snapshot", "Create or restore state snapshots of Meridian config/state", "Session",
    ...
    CommandDef("steer", "Inject a message after the next tool call without interrupting", "Session",
               args_hint="<prompt>"),
    CommandDef("goal", "Set a standing goal Meridian works on across turns until achieved", "Session",
    ...
    CommandDef("busy", "Control what Enter does while Meridian is working", "Configuration",
    ...
    CommandDef("update", "Update Meridian Agent to the latest version", "Info"),
    CommandDef("version", "Show Meridian Agent version", "Info", aliases=("v",)),
...
def slack_native_slashes() -> list[tuple[str, str, str]]:
    ...
    entries.append(("hermes", "Talk to Meridian or run a subcommand", "[subcommand] [args]"))
    seen.add("hermes")
