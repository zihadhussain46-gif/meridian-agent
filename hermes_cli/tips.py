...
TIPS = [
    ...
    "hermes mcp serve runs Meridian itself as an MCP server for other agents.",
    ...
    "hermes backup creates a zip backup of your entire Meridian home directory.",
    ...
    "hermes gateway install sets up Meridian as a system service (systemd/launchd).",
    ...
    "hermes acp runs Meridian as an ACP server for VS Code, Zed, and JetBrains integration.",
    ...
    'hermes dashboard embeds the full Meridian TUI in your browser via xterm.js and a WebSocket PTY.',
