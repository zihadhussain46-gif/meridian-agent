# Meridian Agent v0.9.0 (v2026.4.13)
...
- **Local Web Dashboard** — A new browser-based dashboard for managing your Meridian Agent locally. Configure settings, monitor sessions, browse skills, and manage your gateway — all from a clean web interface without touching config files or the terminal. The easiest way to get started with Hermes.
