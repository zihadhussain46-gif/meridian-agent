...
description: "Catalog of bundled skills that ship with Meridian Agent"
---
...
| [`hermes-agent`](/docs/user-guide/skills/bundled/autonomous-ai-agents/autonomous-ai-agents-hermes-agent) | Configure, extend, or contribute to Meridian Agent. | `autonomous-ai-agents/hermes-agent` |
