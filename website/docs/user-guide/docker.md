...
sidebar_position: 7
title: "Docker"
description: "Running Meridian Agent in Docker and using Docker as a terminal backend"
---

# Meridian Agent — Docker

There are two distinct ways Docker intersects with Meridian Agent:
...
If this is your first time running Meridian Agent, create a data directory on the host and start the container interactively to run the setup wizard:
