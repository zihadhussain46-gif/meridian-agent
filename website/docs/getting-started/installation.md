...
sidebar_position: 2
title: "Installation"
description: "Install Meridian Agent on Linux, macOS, WSL2, native Windows (early beta), or Android via Termux"
---

# Installation

Get Meridian Agent up and running in under two minutes with the one-line installer.
