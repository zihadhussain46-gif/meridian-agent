...
description: "Run Meridian Agent directly on an Android phone with Termux"
---

# Hermes on Android with Termux

This is the tested path for running Meridian Agent directly on an Android phone through [Termux](https://termux.dev/).
