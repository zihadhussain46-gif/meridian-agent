...
const config: Config = {
  ...
  organizationName: 'MeridianAI',
  projectName: 'meridian-agent',
    ...
    [
      'classic',
      {
        docs: {
          ...
          editUrl: 'https:// meridian-agent/edit/main/website/',
        },
        blog: false,
        theme: {
  ...
  themeConfig: {
    ...
    navbar: {
      ...
      items: [
        ...
        {
          href: 'https:// meridian-agent',
          label: 'GitHub',
          position: 'right',
        },
        {
          href: 'https:// MeridianAI',
          label: 'Discord',
          position: 'right',
        },
      ],
    ...
    footer: {
      ...
      links: [
        ...
        },
        {
          title: 'Community',
          items: [
            { label: 'Discord', href: 'https:// MeridianAI' },
            { label: 'GitHub Discussions', href: 'https:// meridian-agent/discussions' },
        ...
        },
        {
          title: 'More',
          items: [
            { label: 'GitHub', href: 'https:// meridian-agent' },
            { label: 'Meridian AI', href: 'https:// MeridianAI.com' },
          ],
        },
      ],
      copyright: `Built by <a href="https:// Meridian AI</a> · MIT License · ${new Date().getFullYear()}`,
    },
    prism: {
